...
import openid.util.HttpUtil;
import openid.util.PayCommonUtil;
import openid.util.XMLUtil;
...
public class PayController {
    ...
    public void doOrder(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        packageParams.put("notify_url", "http://localhost:8080/order?buy");//支付返回地址要外网访问的到， localhost不行，调用下面buy方法。（订单存入数据库）
